...
## Installation
Using the terminal, after navigating to the directory start the application's server by typing 'npm start'. The server is then running and can be viewed on insomnia at 'http://localhost:3001'. From there please reference the walkthrough video [here](https://drive.google.com/file/d/1xqvWiee7NyJVuSV1DQXgkGAsGCEqsJlC/view). And if you are having trouble starting the server please watch here.
